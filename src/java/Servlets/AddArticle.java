...
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement ps = cn.prepareStatement("INSERT INTO articles VALUES((SELECT NVL(MAX(article_id),0)+1 FROM articles),?,?,?,?,SYSDATE,TO_DATE(?,'DD/MM/YYYY HH24:MI'),?,?)");
            ...
            ps.setString(7, request.getParameter("image_url"));
            ps.executeUpdate();
            ps.close();
            //out.print("<script>alert('Article Successfully added !');</script>");
            request.getRequestDispatcher("/JSP/ArticlesList.jsp?msg=Article Successfully added !").forward(request, response);
