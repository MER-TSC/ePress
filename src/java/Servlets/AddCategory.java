...
public class AddCategory extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement ps = cn.prepareStatement("INSERT INTO categories VALUES((SELECT NVL(MAX(category_id),0)+1 FROM categories),?)");
            ps.setString(1, request.getParameter("category_name"));
            ps.executeUpdate();
            ps.close();
            request.getRequestDispatcher("/JSP/ManageCategories.jsp?msg=Category successfully added !").forward(request, response);
