...
public class DeleteArticle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteArticle</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteArticle at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            CallableStatement cs = cn.prepareCall("{CALL delete_article(?)}");
            cs.setInt(1, article_id);
            cs.executeUpdate();
            cs.close();
            request.getRequestDispatcher("/JSP/ArticlesList.jsp?msg=Article successfully deleted !").forward(request, response);
